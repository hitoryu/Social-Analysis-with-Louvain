...
def main():
    parser = argparse.ArgumentParser(description='Social Network Community Analysis')
    parser.add_argument('--dataset', type=str, default='snap', 
                       choices=['synthetic', 'snap', 'kaggle', 'twitter'],
                       help='Dataset to use: synthetic, snap, kaggle, or twitter')
    
    args = parser.parse_args()
    
    print("STARTING SOCIAL NETWORK COMMUNITY ANALYSIS PROJECT")
    print("=" * 50)
    ...
    try:
        ...
        print("STEP 3: Detecting communities with Louvain...")
        ...
        print("STEP 4: Analyzing communities...")
